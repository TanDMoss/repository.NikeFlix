...
def main():
    # Paths to the files
    wizard_addon_file = "./repo/plugin.program.NikeFlix/addon.xml"
    wizard_builds_file = "./repo/plugin.program.NikeFlix/resources/text/builds.txt"
    ...
    print(f"Current version in plugin.program.NikeFlix addon.xml: {wizard_addon_version}")
    print(f"Current version in plugin.program.NikeFlix builds.txt: {wizard_builds_version}")
