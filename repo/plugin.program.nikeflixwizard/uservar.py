...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'nikeflixwizard'
BUILDERNAME = 'nikeflixwizard'
EXCLUDES = [ADDON_ID, '']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/TanDMoss/repository.NikeFlix/ad1dd173884a968700a7baa8463b80caa74835c8/repo/plugin.program.nikeflixwizard/resources/text/builds.txt'
...
YOUTUBETITLE = 'ENTER YOUTUBE NAME'
YOUTUBEFILE = 'http:// ENTER DOMAIN URL FOR YOUTUBE FILE/youtube.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]nikeflixwizard[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing nikeflixwizard.\n\nContact us at nikeflixwizard'
...
REPOID = 'repository.NikeFlix'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'http:// ENTER DOMAIN URL/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'http:// ENTER DOMAIN URL/zips/repository.ENTER REPO NAME/'
#########################################################
...
NOTIFICATION = 'http:// ENTER DOMAIN URL FOR NOTIFY FILE/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]nikeflixwizard[/B][/COLOR]Wizard'
